...
export function createProdSet(mprodarr: Iterable<string>): prod.ProdSet {
...
export function createProdSetWithSplitter(mprodarr: Iterable<string>, splitter?: string): prod.ProdSet {
    let prods: Array<prod.Production> = [];
    for (let mprod of mprodarr) {
