...
export class ProdSet {
    ...
    private _nontprodmap: Array<Array<number>>;
    private _numprodmap: Array<ProductionRef>;
    ...
    private _firstSet: Array<Set<number>>;
    private _followSet: Array<Set<number>>;
    ...
    constructor(prods: Iterable<Production>) {
        ...
        let prodliteralset = new Set<string>(), startnontnum: number, reachedges: Array<utility.Edge> = [], prodidgen = new utility.IdGen(0);
