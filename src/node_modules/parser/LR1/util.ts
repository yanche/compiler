...
export class LR0ItemsDef {
    ...
    constructor(prodset: prod.ProdSet) {
        let prodids = prodset.getProdIds(), startnontnum = prodset.getStartNonTerminal(), itemnummap = new Array<Array<number>>(prodids.length), itemidgen = new utility.IdGen(0), numitemmap = new Array<LR0Item>();
