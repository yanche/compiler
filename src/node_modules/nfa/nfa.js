...
class State {
    ...
    addTransition(str, statenum) {
        if (statenum === this._id && str.length === 0)
            return this;
...
class NFA {
    ...
    toDFA() {
        ...
        let nfaidofstarts = statesId([...this._startclosure]), dfanfastatemap = new Map();
        ...
        return { dfa: DFA_1.createDFA(dfaTrans, startid, terminals), statemap: dfanfastatemap };
    }
}
