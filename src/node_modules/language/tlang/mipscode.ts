...
export function generateMIPSCode(code: i.IntermediateCode): MIPSAssembly {
...
const MIPS_FN_PRINT_INT = '__print_int__';
const MIPS_FN_PRINT_BOOL = '__print_bool__';
const MIPS_FN_PRINT_NEWLINE = '__print_newline__';
const MIPS_GDATA_NEWLINE = '__newline__';
const MIPS_GDATA_TRUE = '__true__';
const MIPS_GDATA_FALSE = '__false__';
export {regs, MIPS_VTABLE_INIT_LABEL, MIPS_FN_PRINT_INT, MIPS_FN_PRINT_BOOL, MIPS_FN_PRINT_NEWLINE, MIPS_GDATA_NEWLINE, MIPS_GDATA_TRUE, MIPS_GDATA_FALSE}
