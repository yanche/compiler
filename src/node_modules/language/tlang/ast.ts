...
function typeAnalysisExprList(exprlist: Array<ASTNode_expr>, parr: Array<util.Type>, classlookup: util.ClassLookup, fnlookup: util.FunctionLookup, ctx: util.Context): util.SemanticCheckReturn {
...
export class ASTNode_functiondef extends ASTNode {
    ...
    typeAnalysis(classlookup: util.ClassLookup, fnlookup: util.FunctionLookup, ctx: util.Context): util.SemanticCheckReturn {
...
export class ASTNode_type extends ASTNode {
    ...
    // tAnalysiseck(classlookup: util.ClassLookup, fnlookup: util.FunctionLookup, ctx: util.Context): util.SemanticCheckReturn {
...
export class ASTNode_for extends ASTNode_statement {
    ...
    codepathAnalysis(inloop: boolean): util.SemanticCheckReturn {
        ...
        if (!mret.accept) return mret;
        mret = this.endstmt.codepathAnalysis(inloop);
        if (!mret.accept) return mret;
        return new util.SemanticCheckReturn(true);
    }
    makeSymbolTable(symboltable: c.SymbolFrame, classlookup: util.ClassLookup): util.SemanticCheckReturn {
...
export class ASTNode_varref extends ASTNode_leftval {
    ...
    typeAnalysis(classlookup: util.ClassLookup, fnlookup: util.FunctionLookup, ctx: util.Context): util.SemanticCheckReturn {
        ...
        else return new util.SemanticCheckReturn(true).setType((<util.SymbolAttrs>this._symboltable.find(this.token.rawstr)).type);
    }
    //for read
    genIntermediateCode(cp: i.CodePiece): number {
