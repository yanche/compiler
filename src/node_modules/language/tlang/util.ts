...
export class FunctionLookup {
    ...
    getApplicableFn(fnname: string, parametertypelist: Array<Type>, classlookup: ClassLookup): Array<FunctionDefinition> {
        let fnlist = this._map.get('').get(fnname);
...
export class ClassDefinition {
    ...
    // getVTableLabel(): string {
    //     return this._name + '__VTABLE';
    // }
...
export class SymbolAttrs extends c.SymbolAttrs {
    constructor(public type: Type) { super(); }
    //used in intermediate code generation
    // private _regid: number;
    // set regId(id: number) {
    //     if (this._regid != null) throw new Error('defensive code, supposed to be set only once');
    //     this._regid = id;
    // }
    // get regId(): number { return this._regid; }
}
