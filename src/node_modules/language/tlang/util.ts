...
export class SymbolAttrs {
    ...
    constructor(public type: Type, idgen: utility.IdGen) {
        this._tmpregid = idgen.next();
    }
...
export class IcContext {
    ...
    loopEndLabel: i.CodeLabel;
    afterLoopLabel: i.CodeLabel;
    constructor() {
...
export class VTableLabel {
    private _classname: string;
    constructor(classname: string) { this._classname = classname; }
    toString(): string {
