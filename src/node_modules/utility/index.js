...
MapOfArr.prototype.getSize = function () {
...
MapOfSet.prototype.addRange = function (key, arr) {
    arr.forEach(item => this.add(key, item));
};
MapOfSet.prototype.get = function (key) {
    return this._map.get(key);
};
MapOfSet.prototype.toMap = function () {
    var map = new Map();
    [...this._map].forEach(m => { map.set(m[0], m[1]); });
    return map;
};
...
exports.calcClosureOfOneNode = clo.calcClosureOfOneNode;
