...
//return: set of node numbers
var calcClosureOfOneNode = function(graph, nodenum) {
    var set = new Set().add(nodenum), queue = [nodenum];
    while(queue.length > 0) {
        var nnum = queue.pop();
        var adjset = graph.edges.get(nnum);
...
//arr: [[0,1], [0,2], [2,1]] -> 3 directed edges: 0 to 1, 0 to 2, 2 to 1
//return: set of node numbers
exports.calcClosureOfOneNode = function (arr, nodenum) {
    return calcClosureOfOneNode(createGraph(arr), nodenum);
};
