...
describe('happy', function () {
    it('1 edge 1 node', function () {
        var m = closure.calcClosure(convToEdges([[0, 0], [0, 0]]));
        var c0 = m.get(0);
    ...
    it('1 edge', function () {
        var m = closure.calcClosure(convToEdges([[0, 1]]));
    ...
    it('2 edges', function () {
        var m = closure.calcClosure(convToEdges([[0, 1], [1, 3]]));
    ...
    it('star', function () {
        var m = closure.calcClosure(convToEdges([[0, 1], [0, 3], [0, 5]]));
    ...
    it('reversed star', function () {
        var m = closure.calcClosure(convToEdges([[1, 0], [3, 0], [5, 0]]));
        var c0 = m.get(0), c1 = m.get(1), c2 = m.get(3), c3 = m.get(5);
        arrEqual([...c0.getNodes()], [0]);
...
describe('loop', function () {
    it('2 nodes', function () {
        var m = closure.calcClosure(convToEdges([[0, 1], [1, 0]]));
        var c0 = m.get(0), c1 = m.get(1);
        assert.equal(c0, c1);
        arrEqual([...c0.getNodes()], [0, 1]);
    ...
    it('4 nodes', function () {
        var m = closure.calcClosure(convToEdges([[0, 1], [1, 2], [2, 3], [3, 0]]));
    ...
    it('3 nodes, several hanging edges', function () {
        var m = closure.calcClosure(convToEdges([[0, 1], [1, 2], [2, 0], [2, 3], [1, 4]]));
    ...
    it('4 nodes, 2 loops', function () {
        var m = closure.calcClosure(convToEdges([[2, 3], [3, 0], [0, 1], [1, 2], [2, 0]]));
        var c0 = m.get(0), c1 = m.get(1), c2 = m.get(2), c3 = m.get(3);
        closuresShareNodes([c0, c1, c2, c3], [0, 1, 2, 3]);
        closuresOwners([c0, c1, c2, c3], [0, 1, 2, 3]);
    });
    ...
    it('4 nodes, 2 loops, intersect', function () {
        var m = closure.calcClosure(convToEdges([[2, 3], [3, 1], [0, 1], [1, 2], [2, 0]]));
        var c0 = m.get(0), c1 = m.get(1), c2 = m.get(2), c3 = m.get(3);
        closuresShareNodes([c0, c1, c2, c3], [0, 1, 2, 3]);
        closuresOwners([c0, c1, c2, c3], [0, 1, 2, 3]);
    });
    ...
    it('3 loops, consider process sequence', function () {
        var m = closure.calcClosure(convToEdges([[2, 3], [3, 1], [0, 1], [1, 2], [2, 0], [0, 4], [4, 5], [5, 0]]));
...
function closuresShareNodes(closures: Array<closure.Closure>, nodes: Array<number>) {
    for (var c of closures) arrEqual(nodes, [...c.getNodes()]);
};

function closuresOwners(closures: Array<closure.Closure>, owners: Array<number>) {
    var set = new Set<number>();
    for (var c of closures)
        for (var n of c.getOwnerNodes())
            set.add(n);
    arrEqual(owners, [...set]);
};
